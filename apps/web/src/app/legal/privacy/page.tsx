...
export default function Privacy() {
  return (
    <div className="prose dark:prose-invert container mx-auto max-w-3xl px-4 py-12">
      ...
      <p>At {env.NEXT_PUBLIC_PROJECT_NAME}, we take your privacy seriously — even in alpha. This policy outlines how we handle your data.</p>
      ...
      <p>
        We don’t sell your data. We may use third-party services (e.g., analytics, hosting) that process data on our behalf under secure
        agreements.
      </p>

      <h2>4. Data Storage</h2>
      <p>
        We store your data securely and limit access to authorized team members. If you want your data deleted, just reach out — we’ll handle it
        quickly.
      </p>

      <h2>5. Changes to This Policy</h2>
      <p>As we grow, this policy may evolve. We’ll notify you of any significant changes.</p>
    </div>
  );
}
