...
function MasonryElement({ className, postData }: { className: string; postData: z.infer<typeof internalPostSchema> }) {
  return (
    <PostTrigger className={className} postId={postData._id}>
