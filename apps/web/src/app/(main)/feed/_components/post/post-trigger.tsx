...
export default function PostTrigger({ postId, children }: { postId: string; children: React.ReactNode }) {
  ...
  return (
    <button
      type="button"
      className="m-4 flex aspect-square w-60 cursor-pointer flex-col items-center gap-2 rounded-md border border-secondary bg-accent p-4 pt-6 text-foreground"
