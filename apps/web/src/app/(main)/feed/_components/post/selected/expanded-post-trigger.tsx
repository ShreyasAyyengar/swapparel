  ...
  return (
    <div className="fixed inset-0 z-2 flex items-center justify-center">
      ...
      <div className="relative max-h-[83vh] w-1/2 items-center overflow-y-auto rounded-2xl border border-secondary bg-accent p-10 pt-5 text-foreground">
        {!canSeeButton && <Ellipsis className={"absolute top-5 right-5 cursor-pointer"} onClick={() => setDeleteDialogOpen((prev) => !prev)} />}
            ...
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                <div className="flex justify-center">
                  <Button
                    variant="outline"
                    className="mt-5 mr-5 flex w-1/3 cursor-pointer items-center justify-center bg-foreground text-black hover:bg-foreground-500"
                    onClick={() => setDeleteDialogOpen(false)}
                  >
                    Cancel
                  </Button>
                  <Button
                    className="mt-5 ml-5 flex w-1/3 cursor-pointer items-center justify-center bg-destructive/50 text-foreground hover:bg-destructive/70"
                    onClick={() => {
                      deletePostMutation.mutateAsync({ id: post._id });
