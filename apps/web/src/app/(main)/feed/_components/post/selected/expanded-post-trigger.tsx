...
export default function ExpandedPostTrigger({ post, children }: { post: z.infer<typeof internalPostSchema>; children: React.ReactNode }) {
  ...
  return (
    <div className="fixed inset-0 z-2 flex items-center justify-center">
      ...
      <div className="z-10 grid max-h-[83vh] w-1/2 grid-cols-1 rounded-2xl border border-secondary bg-accent p-10 text-foreground sm:grid-cols-2">
        <div className="flex h-full items-center justify-center overflow-y-auto border border-lime-500">
