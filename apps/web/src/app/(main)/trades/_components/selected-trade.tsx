...
import {
    ...
    SelectLabel,
    SelectTrigger
} from "@swapparel/shad-ui/components/select";
    ...
    return (
        <div className={"flex h-full flex-col"}>
            <div className="mx-5 mt-5 flex items-center justify-between">
                {/* Swap Date */}
                <div
                    className="w-fit rounded-md border border-secondary/50 bg-accent p-2 text-center font-bold text-bold text-foreground">
                    <Popover
                        onOpenChange={(open) => {
                        ...
                        <div className="flex items-center gap-2">
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    >
                                        {updateTransactionMutation.isPending ?
                                            <LoaderCircle className="animate-spin"/> : <CalendarIcon/>}
                            ...
                            >
                                ...
                                <Input
                                    ...
                                    //   TODO hotfix
                                    defaultValue={new Date("2026-01-10T09:51:11.039Z").toLocaleDateString()}
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <SelectTrigger className="truncate border border-secondary bg-background hover:bg-accent">
                                {updateTransactionMutation.isPending ?
                                    <LoaderCircle className="animate-spin font-mono"/> :
                                    <MapPinPen className="font-mono"/>}
                            ...
                            <SelectContent>
                                <SelectGroup>
                                    ...
                                    {Object.entries(PUBLIC_LOCATIONS).map(([value, label]) => (
                                        <SelectItem key={value} value={label.name}
                                                    onSelect={() => setChangeableLocation(label.name)}>
                                            {label.name}
                                        </SelectItem>
                                    ))}
                                </SelectGroup>
